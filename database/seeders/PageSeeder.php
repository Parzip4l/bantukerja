...
class PageSeeder extends Seeder
{
    public function run(): void
    {
        $pages = [
            ...
            ['title' => 'Hubungi Bantu Kerja', 'slug' => 'contact', 'meta_title' => 'Hubungi Bantu Kerja', 'meta_description' => 'Hubungi tim Bantu Kerja untuk kerja sama, masukan, pelaporan bug, koreksi konten, atau permintaan tools baru.', 'content' => '<p>Kami terbuka untuk masukan, kerja sama, pelaporan masalah, koreksi konten, atau permintaan fitur baru untuk tools dan template Bantu Kerja.</p>'],
